    ...
    var MapVLayer$1 = function () {
        ...
        createClass(MapVLayer, [{
            ...
            value: function bindEvent() {
                ...
                this.scene.postRender.addEventListener(this.innerMoveStart, this);
                this.scene.postRender.addEventListener(this.innerMoveEnd, this);
            ...
            key: 'unbindEvent',
            value: function unbindEvent() {
                this.scene.postRender.removeEventListener(this.innerMoveStart, this);
                this.scene.postRender.removeEventListener(this.innerMoveEnd, this);
            ...
            value: function remove() {
                ...
                void 0 != this.mapvBaseLayer && (this.mapvBaseLayer.clear(this.mapvBaseLayer.getContext()), this.mapvBaseLayer = void 0, this.canvas.parentElement.removeChild(this.canvas));
            }
        }, {
            key: 'update',
