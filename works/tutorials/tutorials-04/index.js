...
// WMTS 服务
var url = 'http://localhost:8011/geoserver/gwc/service/wmts?layer=bj:road&style=&tilematrixset=EPSG:900913&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image%2Fpng&TileMatrix=EPSG:900913:{TileMatrix}&TileCol={TileCol}&TileRow={TileRow}';
...
//   url : "http://localhost:8011/geoserver/gwc/service/tms/1.0.0/bj:road@EPSG:900913@png/{z}/{x}/{reverseY}.png"
// });
...
// <LineSymbolizer>
// <Stroke>
// <CssParameter name="stroke">#EEE685</CssParameter>
